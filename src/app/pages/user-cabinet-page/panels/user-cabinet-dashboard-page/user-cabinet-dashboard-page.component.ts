...
import {faSolidFilter, faSolidMagnifyingGlass} from '@ng-icons/font-awesome/solid';
...
@Component({
  ...
  standalone: true,
  imports: [LottieComponent, UserCabinetDashboardPageTopPartComponent, UserCabinetStatBlock1Component, UserCabinetStatBlock2Component, NgIcon, UserCabinetTopBeltComponent, MatFormField, MatOption, MatSelect, MatLabel]
})
