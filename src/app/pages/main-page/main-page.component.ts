...
@Component({
  ...
  imports: [MainBannerComponent, RowInformationsComponent, HorizontalPersonComponent, WheAreWeComponent, PanelTextWithImageComponent, FooterComponent, HorizontalBlocksComponent]
})
